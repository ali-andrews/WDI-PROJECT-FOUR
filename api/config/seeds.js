...
var product3 = new Product({
  name: "Huggies Wipes Fragrance Free Tub 80",
...
var product5 = new Product({
  name: "Johnson's Bath Top-To-Toe",
...
var product8 = new Product({
  name: "Johnson's Powder Cornstarch And Aloe",
...
var product9 = new Product({
  name: "JBasik Organics Bottom Balm",
...
var product12 = new Product({
  name: "Little Angels Fig and Banana Porridge",
...
var product13 = new Product({
  name: "Farex Original Multigrain Cereal Pouch",
...
var product18 = new Product({
  name: "Heinz Organic Apple Berry Blush Pouch",
